...
//   useEffect(() => {
//     emailjs.init('vlIFGBSbCmALNTrtj');
//   }, []);
...
//         'service_4fvmij5', // Your Service ID
//         'template_1nv99y8', // Your Template ID
//         formRef.current,
//         'vlIFGBSbCmALNTrtj' // Your Public Key
//       );
...
//   useEffect(() => {
//     const observer = new IntersectionObserver(
//       ([entry]) => entry.isIntersecting && entry.target.classList.add('animate-fade-in'),
//       { threshold: 0.1 }
//     );
...
export function Contact() {
  ...
  useEffect(() => {
    emailjs.init('Ob8QSrkJ65Xp6mKcW');
  }, []);
  ...
  useEffect(() => {
    const sectionNode = sectionRef.current; // Capture ref value
    ...
    if (sectionNode) {
      ...
      return () => {
        observer.unobserve(sectionNode); // Use captured variable in cleanup
      };
    }
  }, []);
